...
type TSignAndSendTaskArgs = SignAndSendTaskArgs & { gasLimit: number }

type TSubtaskConfigureTaskArgs = SubtaskConfigureTaskArgs<OAppOmniGraph, IOApp> & { gasLimit: number }
...
task(TASK_LZ_OAPP_WIRE)
    ...
    .setAction(async (args: Args, hre, runSuper) => {
        ...
        subtask(SUBTASK_LZ_OAPP_WIRE_CONFIGURE, 'Configure OFT', (args: TSubtaskConfigureTaskArgs, hre, runSuper) =>
            runSuper({
                ...args,
                gasLimit: 2_000_000,
        ...
        ).addOptionalParam('gasLimit', 'gas limit', '2_000_000')
        ...
        subtask(SUBTASK_LZ_SIGN_AND_SEND, 'Sign OFT transactions', (args: TSignAndSendTaskArgs, _hre, runSuper) =>
            runSuper({
                ...args,
                gasLimit: 2_000_000,
        ...
        return runSuper({ ...args, gasLimit: 2_000_000 })
    })
